Tily.BufferBase = (function() {
	 ...
	 * @type {Object}
	 * @property {String} lockedAxis Indicates which axis is used for scaling the tiles, the scale
	 * parameter will indicate how many tiles are visible on the locked axis. Should be either "x"
	 * or "y".
	 * @property {Number} initialOffsetX The starting offset x-coordinate for this buffer.
	 * @property {Number} initialOffsetY The starting offset y-coordinate for this buffer.
	 * @property {Number} initialScale The starting scale, represents the number of visible tiles
	 * along the locked axis.
	 * @property {Number} maximumScale The maximum number of tiles visible along the locked axis.
	 * @property {Number} minimumScale The minimum number of tiles visible along the locked axis.
	 * @property {Boolean} clampCamera Clamp the camera offset and zoom so that the buffer always
	 * fills the canvas.
	 */
	/**
	 ...
	 * @property {String} unit The unit of measurement for the new offset, either "px" or "tile".
