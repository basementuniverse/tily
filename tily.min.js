...
ActiveTile.prototype.addLayer=function(layer,z){layer=layer||new Tily.ActiveTileLayer(this);layer.activeTile=this;layer.parent=this;return _super.prototype.addLayer.call(this,layer,z);};function drawLayers(layers,context,elapsedTime,tileSize){for(let i=0,length=layers.length;i<length;i++){layers[i].draw(context,elapsedTime,tileSize);}}
