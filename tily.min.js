...
(function(){Tily.utility={clamp:function(a,min,max){if(min===undefined){min=0;};if(max===undefined){max=1;};return(a<min?min:(a>max?max:a));},lerp:function(a,b,i){return a*(1-i)+b*i;}};"use strict";var vec2=function(x,y){if(arguments.length==1){if(x instanceof Array&&x.length>1){return{x:x[0],y:x[1]};}else if(x.x!==undefined&&x.y!==undefined){return{x:x.x,y:x.y};}
return{x:0,y:0};}
