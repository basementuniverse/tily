...
this.activeTile.text=text;};return TextAnimation;}(Tily.Animation));Tily.OutlineAnimation=(function(_super){"use strict";__extends(OutlineAnimation,_super);function OutlineAnimation(activeTile,start,finish,options){_super.call(this,activeTile,start,finish,options);}
OutlineAnimation.prototype.update=function(elapsedTime){const amount=_super.prototype.update.call(this,elapsedTime);const start=Tily.utility.outline(this.start);start.colour=parseColor(start.colour);const finish=Tily.utility.outline(this.finish);finish.colour=parseColor(finish.colour);const outlineWidth=this.easeFunction(start.width,finish.width,amount);const outlineColour={r:this.easeFunction(start.colour.r,finish.colour.r,amount),g:this.easeFunction(start.colour.g,finish.colour.g,amount),b:this.easeFunction(start.colour.b,finish.colour.b,amount),a:this.easeFunction(start.colour.a,finish.colour.a,amount)};this.activeTile.outline=`${outlineWidth} ${Tily.utility.colour(outlineColour)}`;};return OutlineAnimation;}(Tily.Animation));Tily.ShadowAnimation=(function(_super){"use strict";__extends(ShadowAnimation,_super);function ShadowAnimation(activeTile,start,finish,options){_super.call(this,activeTile,start,finish,options);}
ShadowAnimation.prototype.update=function(elapsedTime){const amount=_super.prototype.update.call(this,elapsedTime);const start=Tily.utility.shadow(this.start);start.colour=parseColor(start.colour);const finish=Tily.utility.shadow(this.finish);finish.colour=parseColor(finish.colour);const shadowBlur=this.easeFunction(start.blur,finish.blur,amount);const shadowXOffset=this.easeFunction(start.xOffset,finish.xOffset,amount);const shadowYOffset=this.easeFunction(start.yOffset,finish.yOffset,amount);const shadowColour={r:this.easeFunction(start.colour.r,finish.colour.r,amount),g:this.easeFunction(start.colour.g,finish.colour.g,amount),b:this.easeFunction(start.colour.b,finish.colour.b,amount),a:this.easeFunction(start.colour.a,finish.colour.a,amount)};this.activeTile.shadow=`${shadowBlur} ${shadowXOffset} ${shadowYOffset} ${Tily.utility.colour(shadowColour)}`;};return ShadowAnimation;}(Tily.Animation));if(typeof module!=="undefined"){module.exports={Tily:Tily,vec2:vec2};}
